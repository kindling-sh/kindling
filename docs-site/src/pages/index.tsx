      ...
      <div className={styles.heroInner}>
        ...
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroDescription}>
            Minimize the time from idea to prod. Designed for builders,
            Kindling layers SDLC best practices in, so your project —
            multi-agent architectures, microservices or any flavor of
            containerized apps — runs everywhere. Your project just works.
            In prod.
          </p>
          <InstallCommand />
